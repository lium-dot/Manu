...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'Manu-MD&kREesGG5', // Put your session id here ( after linked check your number and get session id it need start with Manu-MD& ) 🤍
